...
DATASETS = {
    ...
    'dehollander_dotcloud': {
        'subdir': 'dehollander_dotcloud/dotcloud/30subj',
        'fits': {
            ...
            'RDM':          ('rdm_freescale_full.nc',           'rdm'),
            'RDM-flex':     ('rdm_flex_freescale_full.nc',      'rdm-flex'),
        },
    ...
    'dehollander_symbolic': {
        'subdir': 'dehollander_symbolic/symbolic/58subj',
        'fits': {
            'choice':       ('choice_full.nc',                  'static'),
            'choice-flex':  ('choice_flex_full.nc',             'static-flex'),
            'DDM':          ('ddm_freescale_full.nc',           'ddm'),
